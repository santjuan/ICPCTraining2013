...
public class Pinball 
{
	...
	static class Segment implements Comparable <Segment>
	{
		...
		public Segment(Scanner sc)
		{
			...
			leftMost.x += 1000000;
			leftMost.y += 1000000;
			leftMost.y = 2000000 - leftMost.y;
			rightMost.x += 1000000;
			rightMost.y += 1000000;
			rightMost.y = 2000000 - rightMost.y;
	...
	static final Event[] eventTmp = new Event[2000010];
	...
	public static void main(String[] args) throws IOException
	{
		...
		while(true)
		{
			...
			Segment ceiling = new Segment(new Point(-1, 2000001));
			ceiling.rightMost = new Point(2000001, 2000001);
			...
			for(Segment s : segmentQueries)
			{
				if(s.answer.where == ceiling)
					bw.write(((int) s.answer.xValue - 1000000) + "\n");
				else
